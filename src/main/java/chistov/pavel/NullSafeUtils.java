...
/**
 * Класс с набором вспомагательных методов для поиска и получения значений в глубину по иерархии.
 */
public final class NullSafeUtils {
   ...
   * Данный метод лучше всего использовать в тех случая, когда вы уверены, что значения на каждом шаге (уровне иерархии) существует,
   * но для перестраховки от {@link NullPointerException} лучше воспользоваться доп. механизмом.
   *
   ...
   * Данный метод лучше всего использовать в тех случая, когда вы не уверены, что значения на каждом шаге (уровне иерархии) существует.
   ...
   * @param firstGetterFunction {@link Function} для получения желаемого значения на первом уровне иерархии;
   ...
   * @param a                    родительский объект, из которого будет изъято желаемое значение;
   * @param firstGetterFunction  {@link Function} для получения желаемого значения на первом уровне иерархии;
   * @param secondGetterFunction {@link Function} для получения желаемого значения на втором уровне иерархии;
   * @param <A>                  тип прнимаемого значения;
   ...
   * @param firstGetterFunction  {@link Function} для получения желаемого значения на первом уровне иерархии;
   * @param secondGetterFunction {@link Function} для получения желаемого значения на втором уровне иерархии;
   * @param thirdGetterFunction  {@link Function} для получения желаемого значения на третьем уровне иерархии;
   * @param <A>                  тип прнимаемого значения;
   * @param <B>                  тип промежуточного значения на первом уровне вложенности;
   ...
   * @param secondGetterFunction {@link Function} для получения желаемого значения на втором уровне иерархии;
   * @param thirdGetterFunction  {@link Function} для получения желаемого значения на третьем уровне иерархии;
   * @param fourthGetterFunction {@link Function} для получения желаемого значения на четвертом уровне иерархии;
   * @param <A>                  тип прнимаемого значения;
   * @param <B>                  тип промежуточного значения на первом уровне вложенности;
   * @param <C>                  тип промежуточного значения на втором уровне вложенности;
   ...
   * @param thirdGetterFunction  {@link Function} для получения желаемого значения на третьем уровне иерархии;
   * @param fourthGetterFunction {@link Function} для получения желаемого значения на четвертом уровне иерархии;
   * @param fifthGetterFunction  {@link Function} для получения желаемого значения на пятом уровне иерархии;
   * @param <A>                  тип прнимаемого значения;
   * @param <B>                  тип промежуточного значения на первом уровне вложенности;
   * @param <C>                  тип промежуточного значения на втором уровне вложенности;
   * @param <D>                  тип промежуточного значения на третьем уровне вложенности;
   ...
   * @param fourthGetterFunction {@link Function} для получения желаемого значения на четвертом уровне иерархии;
   * @param fifthGetterFunction  {@link Function} для получения желаемого значения на пятом уровне иерархии;
   * @param sixthGetterFunction  {@link Function} для получения желаемого значения на шестом уровне иерархии;
   * @param <A>                  тип прнимаемого значения;
   * @param <B>                  тип промежуточного значения на первом уровне вложенности;
   * @param <C>                  тип промежуточного значения на втором уровне вложенности;
   * @param <D>                  тип промежуточного значения на третьем уровне вложенности;
   ...
   * @param fifthGetterFunction   {@link Function} для получения желаемого значения на пятом уровне иерархии;
   * @param sixthGetterFunction   {@link Function} для получения желаемого значения на шестом уровне иерархии;
   * @param seventhGetterFunction {@link Function} для получения желаемого значения на седьмом уровне иерархии;
   * @param <A>                   тип прнимаемого значения;
   * @param <B>                   тип промежуточного значения на первом уровне вложенности;
   * @param <C>                   тип промежуточного значения на втором уровне вложенности;
   * @param <D>                   тип промежуточного значения на третьем уровне вложенности;
   ...
   * @param sixthGetterFunction   {@link Function} для получения желаемого значения на шестом уровне иерархии;
   * @param seventhGetterFunction {@link Function} для получения желаемого значения на седьмом уровне иерархии;
   * @param eighthGetterFunction  {@link Function} для получения желаемого значения на восьмом уровне иерархии;
   * @param <A>                   тип прнимаемого значения;
   * @param <B>                   тип промежуточного значения на первом уровне вложенности;
   * @param <C>                   тип промежуточного значения на втором уровне вложенности;
   * @param <D>                   тип промежуточного значения на третьем уровне вложенности;
   ...
   * @param seventhGetterFunction {@link Function} для получения желаемого значения на седьмом уровне иерархии;
   * @param eighthGetterFunction  {@link Function} для получения желаемого значения на восьмом уровне иерархии;
   * @param ninthGetterFunction   {@link Function} для получения желаемого значения на девятом уровне иерархии;
   * @param <A>                   тип прнимаемого значения;
   * @param <B>                   тип промежуточного значения на первом уровне вложенности;
   * @param <C>                   тип промежуточного значения на втором уровне вложенности;
   * @param <D>                   тип промежуточного значения на третьем уровне вложенности;
